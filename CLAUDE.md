...
The project architecture refers to [architecture](./architecture.md)
...
each method with variables
create an api reference for this smart contract for all the methods and var
